...
⚠️ *These endpoints are constantly evolving. We do our best to minimize impact but please be aware there might require action on your part when new changes are released.*
...
* All endpoints require authentication using JWT tokens which is explained further below.
...
The above will yeild the following response:
