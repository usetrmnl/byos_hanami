...
:doc_internationalization_link: link:https://github.com/usetrmnl/terminus/blob/main/doc/internationalization.adoc[Internationalization]
...
See {doc_internationalization_link} documentation for details.
