...
RSpec.describe Terminus::Aspects::Screens::Converters::TwoBit do
  subject(:converter) { described_class.new }

  include_context "with application dependencies"

  describe "#call" do
    let(:model) { Factory.structs[:model, bit_depth: 2, colors: 4] }
    ...
    it "creates screenshot" do
      ...
      expect(image).to have_attributes(
        ...
        type: "PNG",
        data: hash_including(
          "colormap" => %w[#000000FF #555555FF #AAAAAAFF #FFFFFFFF],
          "depth" => 2,
          "type" => "Grayscale"
        )
      )
