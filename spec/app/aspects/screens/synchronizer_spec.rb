...
RSpec.describe Terminus::Aspects::Screens::Synchronizer, :db do
  ...
  describe "#call" do
    ...
    it "updates existing record with new attachment" do
      model
      Factory[:screen, :with_attachment, name: "plugin-1745348489.png"]
    ...
    it "fails when screen can't be associated with model" do
      Factory[:screen, :with_attachment, name: "plugin-1745348489.png"]
      expect(synchronizer.call(display)).to be_failure("Unable to associate model with screen.")
    end
