...
--
-- Name: screen_templates; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: screen_templates_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.screen_templates ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.screen_templates_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: screen_templates screen_templates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screen_templates
...
--
-- Name: screen_templates_device_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX screen_templates_device_id_index ON public.screen_templates USING btree (device_id);
...
--
-- Name: screen_templates screen_templates_device_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screen_templates
    ADD CONSTRAINT screen_templates_device_id_fkey FOREIGN KEY (device_id) REFERENCES public.devices(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
('20250416145454_create_screen_templates.rb');
