...
--
-- Name: membership_account_id_user_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX membership_account_id_user_id_index ON public.membership USING btree (account_id, user_id);
...
('20250909161810_create_account.rb'),
('20250909161829_create_user.rb'),
('20250909161847_create_membership.rb');
