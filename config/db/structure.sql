...
CREATE TABLE public.screens (
    ...
    uri text,
    attachment jsonb DEFAULT '{}'::jsonb NOT NULL,
    rendered boolean DEFAULT true NOT NULL,
...
--
-- Name: screens screens_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screens
    ADD CONSTRAINT screens_name_key UNIQUE (name);
...
--
-- Name: firmwares_attachment_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX firmwares_attachment_index ON public.firmwares USING gin (attachment);


--
-- Name: screens_attachment_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX screens_attachment_index ON public.screens USING gin (attachment);
