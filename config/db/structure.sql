...
\restrict K6JbhIZmxfrvaeCSsGZSxfqZjWIjnmE59MdTH8Rejc6jXQPZhO61XruFCuSkBLq
...
--
-- Name: extension_mode_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.extension_mode_enum AS ENUM (
    'dark',
    'light'
);
...
--
-- Name: extension_repeat_type_enum; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.extension_repeat_type_enum AS ENUM (
    'none',
    'minute',
    'hour',
    'day',
...
CREATE TABLE public.extension (
    ...
    mode public.extension_mode_enum DEFAULT 'light'::public.extension_mode_enum NOT NULL,
    ...
    poll_body jsonb DEFAULT '{}'::jsonb NOT NULL,
    static_body jsonb DEFAULT '{}'::jsonb NOT NULL,
    fields jsonb DEFAULT '{}'::jsonb NOT NULL,
    padding boolean DEFAULT false NOT NULL,
    template_full text,
    template_horizontal text,
    template_vertical text,
    template_quarter text,
    template_shared text,
    repeat_interval integer DEFAULT 1 NOT NULL,
    repeat_type public.extension_repeat_type_enum DEFAULT 'none'::public.extension_repeat_type_enum NOT NULL,
    repeat_days text[] DEFAULT '{}'::text[] NOT NULL,
...
--
-- Name: extension_repeat_type_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX extension_repeat_type_index ON public.extension USING btree (repeat_type);
...
\unrestrict K6JbhIZmxfrvaeCSsGZSxfqZjWIjnmE59MdTH8Rejc6jXQPZhO61XruFCuSkBLq
...
('20251014103858_create_extension.rb');
