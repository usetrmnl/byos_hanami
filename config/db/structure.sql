...
\restrict mkJHgktt7kqK0G0pnmjPSadVK9mQ6YuQ5wpDCg4bqTXPDqu8jvM6DKiiYoizHAG
...
--
-- Name: user_email_auth_key; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.user_email_auth_key (
    id bigint NOT NULL,
    key text NOT NULL,
...
--
-- Name: user_lockout; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.user_lockout (
    id bigint NOT NULL,
    key text NOT NULL,
    deadline timestamp without time zone DEFAULT ((CURRENT_TIMESTAMP)::timestamp without time zone + make_interval(days => 1)) NOT NULL,
...
--
-- Name: user_login_change_key; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.user_login_change_key (
    id bigint NOT NULL,
    key text NOT NULL,
    login text NOT NULL,
    deadline timestamp without time zone DEFAULT ((CURRENT_TIMESTAMP)::timestamp without time zone + make_interval(days => 1)) NOT NULL
...
--
-- Name: user_login_failure; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.user_login_failure (
    id bigint NOT NULL,
...
CREATE TABLE public.user_password_reset_key (
    id bigint NOT NULL,
    key text NOT NULL,
    deadline timestamp without time zone DEFAULT ((CURRENT_TIMESTAMP)::timestamp without time zone + make_interval(days => 1)) NOT NULL,
    email_last_sent timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
...
--
-- Name: user_verification_key; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.user_verification_key (
    id bigint NOT NULL,
    key text NOT NULL,
...
--
-- Name: user_email_auth_key user_email_auth_key_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_email_auth_key
    ADD CONSTRAINT user_email_auth_key_pkey PRIMARY KEY (id);
...
--
-- Name: user_lockout user_lockout_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_lockout
    ADD CONSTRAINT user_lockout_pkey PRIMARY KEY (id);


--
-- Name: user_login_change_key user_login_change_key_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_login_change_key
    ADD CONSTRAINT user_login_change_key_pkey PRIMARY KEY (id);


--
-- Name: user_login_failure user_login_failure_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_password_reset_key user_password_reset_key_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_password_reset_key
    ADD CONSTRAINT user_password_reset_key_pkey PRIMARY KEY (id);
...
--
-- Name: user_verification_key user_verification_key_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_verification_key
    ADD CONSTRAINT user_verification_key_pkey PRIMARY KEY (id);
...
--
-- Name: user_email_auth_key user_email_auth_key_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_email_auth_key
    ADD CONSTRAINT user_email_auth_key_id_fkey FOREIGN KEY (id) REFERENCES public."user"(id);
...
--
-- Name: user_lockout user_lockout_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_lockout
    ADD CONSTRAINT user_lockout_id_fkey FOREIGN KEY (id) REFERENCES public."user"(id);


--
-- Name: user_login_change_key user_login_change_key_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_login_change_key
    ADD CONSTRAINT user_login_change_key_id_fkey FOREIGN KEY (id) REFERENCES public."user"(id);


--
-- Name: user_login_failure user_login_failure_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_login_failure
    ADD CONSTRAINT user_login_failure_id_fkey FOREIGN KEY (id) REFERENCES public."user"(id);
...
ALTER TABLE ONLY public.user_password_reset_key
    ADD CONSTRAINT user_password_reset_key_id_fkey FOREIGN KEY (id) REFERENCES public."user"(id);
...
--
-- Name: user_verification_key user_verification_key_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_verification_key
    ADD CONSTRAINT user_verification_key_id_fkey FOREIGN KEY (id) REFERENCES public."user"(id);
...
\unrestrict mkJHgktt7kqK0G0pnmjPSadVK9mQ6YuQ5wpDCg4bqTXPDqu8jvM6DKiiYoizHAG
