...
ROM::SQL.migration do
  change do
    ...
    create_table :extension do
      ...
      column :uri, String
      column :poll_body, :jsonb, null: false, default: "{}"
      column :static_body, :jsonb, null: false, default: "{}"
      column :fields, :jsonb, null: false, default: "{}"
      column :padding, :boolean, null: false, default: false
      column :template_full, :text
      column :template_horizontal, :text
      column :template_vertical, :text
      column :template_quarter, :text
      column :template_shared, :text
      column :repeat_interval, Integer, null: false, default: 1
      column :repeat_type, :extension_repeat_type_enum, index: true, null: false, default: "day"
